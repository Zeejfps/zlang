...
public class Tests
{
    ...
    public void TestGenericStructAssignment()
    {
        ...
        Assert.That(tokens, Is.EquivalentTo(new[]
        {
            ...
            new Token(TokenKind.SymbolLeftAngleBracket, "<", 1, 13),
            new Token(TokenKind.Identifier, "T", 1, 14),
            new Token(TokenKind.SymbolRightAngleBracket, ">", 1, 15),
            ...
            new Token(TokenKind.SymbolLeftAngleBracket, "<", 1, 30),
            new Token(TokenKind.Identifier, "T", 1, 31),
            new Token(TokenKind.SymbolRightAngleBracket, ">", 1, 32),
    ...
    public void TestVarAssignmentToStruct()
    {
        ...
        Assert.That(tokens, Is.EquivalentTo(new[]
        {
            ...
            new Token(TokenKind.SymbolRightAngleBracket, ">", 1, 16),
